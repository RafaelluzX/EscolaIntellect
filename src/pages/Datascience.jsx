    ...
    <>
      ...
      <div>
        <section className="presentation-class-courses container mt-4">
          <h2 className="title-presentation">QUER APRENDER DATA SCIENCE?</h2>
        ...
        <section className="cards-courses container d-flex flex-wrap gap-1 justify-content-center">
          <Card titleCurse="Estatística" />
          <Card titleCurse="Python" />
          <Card titleCurse="SQL" />
          <Card titleCurse="STORYTELLING" />
          <Card titleCurse="POWER BI" />
        </section>
        <section className="experts-presentation container mt-5">
          <h2 className="title-experts-presentation">
            Conheça os experts dos cursos de DATA SCIENCE
          </h2>
          <p>
